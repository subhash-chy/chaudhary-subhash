...
import { fadeAnimation, triggerXSlide } from "../styles/animations";
    ...
    <>
      ...
      <Layout>
        ...
        <div className="mt-12 mx-5 md:mx-auto  px-5 max-w-[70ch]">
          ...
          <h2 className="fadeAnim text-xl font-semibold mb-4  ">Consent</h2>
          ...
          <h2 className="fadeAnim text-xl font-semibold mb-4  ">
          ...
          <p className="mb-5 ">
            ...
            advertising partners of ChaudharySubash.
          </p>

          <p className="mb-5 ">
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on ChaudharySubash,
          ...
          <p className="mb-5 ">
            ChaudharySubash's Privacy Policy does not apply to other advertisers
          ...
          <p className="mb-5 ">
            ChaudharySubash does not knowingly collect any Personal Identifiable
